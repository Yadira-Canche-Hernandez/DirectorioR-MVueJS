  ...
  <div class="items-center h-screen" >
    ...
    <div class="flex bg-white rounded-lg py-2 px-2 mt-5 my-4 mb-5 gap-5 mx-7">
      ...
      <p class="text-xl m-2 py-5 text-black text-left ">
        ...
        <br>
        <br>
        En cualquier caso, la serie es una factoría de personajes fascinantes, así que el resto de la familia -incluso las menos atendidas mujeres- es igualmente interesante y prácticamente en cada capítulo descubrimos a una amplia nómina de seres de todo tipo que pasan a engrosar la galería de tan recomendable producción.
      </p>
      
      <img src="../components/icons/Rick-y-Morty.jpg"  width="300" height="80" class="center m-3">
